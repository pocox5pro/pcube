            ...
            <div className="w-80 max-w-full px-4 xl:mr-12">
              ...
              >
                <Image
                  ...
                  width={200}
                  height={30}
                  className="w-60 h-[35px] dark:hidden"
                />

                {/* <div className="font-3xl ml-2 font-extrabold text-blue-900">
                  <div>PCUBE</div>
                  <div>Technology</div>
                </div> */}
                <Image
                  ...
                  width={200}
                  height={30}
                  className="hidden w-50 h-[35px] dark:block"
                />
              </Link>
            </div>
            <div className="flex w-full items-center justify-between px-4">
              <div>
                <button
                  ...
                  className="absolute right-4 top-1/2 block translate-y-[-50%] rounded-lg px-3 py-[6px] mr-10 ring-primary focus:ring-2 lg:hidden"
                >
                  <span
